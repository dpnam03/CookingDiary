        ...
        <div class="row align-items-center">
            <div class="col-lg-4 col-md-4">
                <div class="header_account">
                   Đinh Phương Nam - KTPM1-K14
                </div>
            </div>
            <div class="col-lg-8 col-md-9">
                <div class="top_right text-right">
                    <div class="header_support" style="margin-top: -7px">
                        <p><i class="fas fa-phone-volume"></i> 24/7 - Hỗ trợ : 0382788384 </p>
                    </div>
                    <div class="header_account" style="margin-top: -15px">
                        <ul>
                            @if(Auth::check())
                            <li>
                              <a href="{{ route('logouts') }}"><i class="fas fa-sign-out-alt"></i> Đăng xuất</a>
                            </li>
                            @else
                              <a href="{{ route('logins') }}"><i class="fas fa-sign-in-alt"></i> Đăng nhập</a>/<a href="{{ route('registers') }}">Đăng ký
                            @endif
                            <li class="wishlist">
          ...
          <div class="row col-md-10">
            ...
            <div class="iconAccount col-md-3">
              @if(Auth::user()->avatar <> null)
                <a href="{{ route('get-information',Auth::user()->id) }}"><img style="border-radius:50%; margin-left: 180px; " width="38px"; height="38px" src="upload/avatar/{{ Auth::user()->avatar }}" alt="">
                <ul class="dropdown_links">
                      @if((Auth::user()->role == 1) || (Auth::user()->role == 2) || (Auth::user()->role == 3))
                      <li>
              ...
              @else
                <a href="{{ route('get-information',Auth::user()->id) }}"><img style="border-radius:50%; margin-left: 180px; " width="38px"; height="38px" src="upload/icon/account.png" alt="">
                  <ul class="dropdown_links">
                      @if(Auth::user()->role == 1 || Auth::user()->role == 2|| (Auth::user()->role == 3))
                      <li>
                        <a href="{{ route('dashboard') }}">Quản trị</a>
